About sqlalchemy_exasol-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sqlalchemy_exasol-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sqlalchemy_exasol-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sqlalchemy_exasol
# for installing globally
pixi global install sqlalchemy_exasol
```
...
It is possible to list all of the versions of `sqlalchemy_exasol` available on your platform:
...
```
pixi search sqlalchemy_exasol --channel conda-forge
```
